<template>
  <div>
    <div id="TsdateEchart" :style="{width: '1200px', height: '440px'}"></div>
  </div>
</template>
...
export default {
  data () {
    return {
      ...
      getData: [
        ...
        {name: '5月', data: [210, 390, 267, 300, 101, 134, 90, 230, 234, 300, 420, 134, 90, 230]}
      ],
      //  默认选中的选项
      select: {
        '1月': false,
  ...
  methods: {
    ...
    drawLine () {
      let myChart = this.$echarts.init(document.getElementById('TsdateEchart'))
      let option = {
        tooltip: {
          trigger: 'axis'
        },
