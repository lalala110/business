<template>
  <div>
    <div id="FtimeEchart" :style="{width: '1200px', height: '440px'}"></div>
  </div>
</template>
...
export default {
  data () {
    return {
      getX: ['1:00', '2:00', '3:00', '4:00', '5:00', '6:00', '7:00', '8:00', '9:00', '10:00', '11:00', '12:00', '13:00', '14:00', '15:00', '16:00', '17:00', '18:00', '19:00', '20:00', '21:00', '22:00', '23:00', '24:00', '0:00'],
      getData: [
        {name: '4.15', data: [420, 132, 101, 134, 90, 230, 210, 345, 280, 270, 180, 256, 234, 290]},
        {name: '4.16', data: [320, 200, 256, 234, 290, 230, 210, 390, 267, 300, 101, 134, 90, 230]},
        {name: '4.17', data: [220, 230, 256, 234, 290, 230, 210, 390, 267, 300, 101, 134, 90, 230]},
        {name: '4.18', data: [120, 230, 256, 234, 290, 230, 234, 290, 230, 101, 134, 90, 230, 240]}
      ],
      //  默认选中的选项
      select: {
        // '4.15': false,
  ...
  methods: {
    ...
    drawLine () {
      let myChart = this.$echarts.init(document.getElementById('FtimeEchart'))
      let option = {
        tooltip: {
          trigger: 'axis'
        },
